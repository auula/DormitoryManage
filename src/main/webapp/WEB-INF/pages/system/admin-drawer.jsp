    ...
    <ul class="mdui-list" mdui-collapse="{accordion: true}">
        ...
        <li class="mdui-collapse-item mdui-collapse-item-open">
            ...
            <ul class="mdui-collapse-item-body mdui-list mdui-list-dense">
                <li class="mdui-list-item mdui-ripple" onclick="view('key');">宿管员管理</li>
                <li class="mdui-list-item mdui-ripple" onclick="view('info');">宿舍楼管理</li>
                <li class="mdui-list-item mdui-ripple" onclick="view('info');">学生管理</li>
                <li class="mdui-list-item mdui-ripple" onclick="view('topup');">缺勤记录</li>
                <li class="mdui-list-item mdui-ripple" onclick="view('OSPwd');">上传公告</li>
                <li class="mdui-list-item mdui-ripple" onclick="view('OSPwd');">查看工单</li>
